...
use kalanis\kw_modules\ModulesLists\KwMapper;
...
class MapperTest extends CommonTestClass
{
     ...
     */
    protected function getLib(XRecord $record): KwMapper
    {
        $storage = new Memory();
        ...
        $file = new KwMapper($record, new KwMapper\Translate(), new ParamsFormat\Http());
