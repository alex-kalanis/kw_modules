 ...
 */
class KwMapper implements Lists\IModulesList
{
    /** @var int */
    protected $level = Lists\ISitePart::SITE_NOWHERE;
    /** @var KwMapper\Translate */
    ...
    public function __construct(ARecord $record, KwMapper\Translate $tr, Lists\File\IParamFormat $format)
    {
        $this->record = $record;
        $this->translate = $tr;
        $this->format = $format;
